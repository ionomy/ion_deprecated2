...
class WalletTest(IonTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 ION from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 ion in block rewards plus fees, but
        ...
        # Send 10 ION with subtract fee from amount
        ...
        # Sendmany 10 ION with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/cevap/ion/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
