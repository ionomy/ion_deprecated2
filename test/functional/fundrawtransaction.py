...
class RawTransactionsTest(IonTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_jsonrpc(-5, "changeAddress must be a valid ion address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
        ...
        iond_processes[1].wait(timeout=IOND_PROC_WAIT_TIMEOUT)
