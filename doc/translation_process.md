...
See the [Transifex Ion project](https://www.transifex.com/projects/p/ion/) to assist in translations. You should also join the translation mailing list for announcements - see details below.
...
You can find the Ion translation project at [https://www.transifex.com/projects/p/ion/](https://www.transifex.com/projects/p/ion/).
...
The Ion-Core translation maintainers include *tcatm, seone, Diapolo, wumpus and luke-jr*. You can find them, and others, in the Freenode IRC chatroom - `irc.freenode.net #ion-core-dev`.

If you are a translator, you should also subscribe to the mailing list, https://groups.google.com/forum/#!forum/ion-translators. Announcements will be posted during application pre-releases to notify translators to check for updates.
