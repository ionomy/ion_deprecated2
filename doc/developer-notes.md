...
Run with the -testnet option to run with "play ions" on the test network, if you
...
- ThreadSocketHandler : Sends/Receives data from peers on port 12705.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 12700 for connections and services them.
...
Some of these are maintained by active developers of Ion Core, in which case changes should probably go
...
- src/libsecp256k1
  - Upstream at https://github.com/ion-core/secp256k1/ ; actively maintaned by Core contributors.

- src/crypto/ctaes
  - Upstream at https://github.com/ion-core/ctaes ; actively maintained by Core contributors.
...
- When looking at other's pull requests, it may make sense to add the following section to your `.git/config`
  file:
        ...
        [remote "upstream-pull"]
                ...
                url = git@github.com:ion/ion.git
