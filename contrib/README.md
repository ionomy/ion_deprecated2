...
### [RPM](/contrib/rpm) ###
RPM spec file for building ion-core on RPM based distributions
...
This script attempts to download and verify the signature file SHA256SUMS.asc from ioncoin.org.
