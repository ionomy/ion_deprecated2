...
maintained:
* for `src/secp256k1`: https://github.com/ion-core/secp256k1.git (branch master)
* for `src/leveldb`: https://github.com/ion-core/leveldb.git (branch ion-fork)
* for `src/univalue`: https://github.com/ion-core/univalue.git (branch master)
* for `src/crypto/ctaes`: https://github.com/ion-core/ctaes.git (branch master)
...
Configuring the github-merge tool for the ion repository is done in the following way:
    ...
    git config githubmerge.repository ion/ion
