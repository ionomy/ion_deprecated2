...
###   This script attempts to download the signature file SHA256SUMS.asc from ioncoin.org
...
WORKINGDIR="/tmp/ion_verify_binaries"
TMPFILE="hashes.tmp"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test"
BASEDIR="https://ioncoin.org/bin/"
VERSIONPREFIX="ion-core-"
RCVERSIONSTRING="rc"
...
if [ $RET -ne 0 ]; then
   if [ $RET -eq 1 ]; then
      ...
      echo "gpg error. Do you have the Ion Core binary release signing key installed?"
   fi
